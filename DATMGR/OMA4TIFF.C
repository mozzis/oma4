...
/* Description: Saves and Loads OMA4 Curvesets in Tagged Image File Format */
/*                                                                         */
/***************************************************************************/
...
****************************************************************************/
ERROR_CATEGORY WriteFileDirectory(FILE *fptr, TIFF *Tiff,
...
****************************************************************************/
ERROR_CATEGORY WriteStripCnt(FILE *fptr, TIFF *Tiff,
                             SHORT serial, SHORT image)
{
...
****************************************************************************/
ERROR_CATEGORY WriteResolutionValues(FILE *fptr, TIFF *Tiff,
                                     SHORT serial, SHORT image)
{
  LONG FilePosition,           /* Used to hold the current file pos.  */
...
****************************************************************************/
ERROR_CATEGORY WriteStripOffset(FILE *fptr, TIFF *Tiff,
                                SHORT serial, SHORT image)
{
  SHORT i;
...
****************************************************************************/
ERROR_CATEGORY trans_TIFF256(FILE* fptr, const char * fName,
                             CURVEDIR *CvDir,
